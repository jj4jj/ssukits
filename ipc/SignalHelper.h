...
public:
    ...
    static  int  AlarmInSeconds(int iSeconds);   
    ...
    //reffer to apue
    static  int  SignalMayBeUnReliable(int signo,sighandler_t handler);
  
    static  int  SignalReliable(int signo,sighandler_t handler);
